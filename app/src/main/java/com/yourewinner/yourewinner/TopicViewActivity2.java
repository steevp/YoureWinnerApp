...
public class TopicViewActivity2 extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            ...
            mScrollPos = savedInstanceState.getInt(ARG_SCROLL_POS);
    ...
    protected void onSaveInstanceState(Bundle outState) {
        ...
        outState.putInt(ARG_SCROLL_POS, mScrollPos);
    ...
    private class TopicViewPagerAdapter extends FragmentStatePagerAdapter {
        ...
        public Fragment getItem(int position) {
            final boolean jumpToUnread;
            final int scrollPos;
            if (mFirstLoad && position == 0) {
                // Jump to unread on first load
                jumpToUnread = true;
                mFirstLoad = false;
            } else {
                jumpToUnread = false;
            ...
            return TopicViewPageFragment.newInstance(mTopicID, position + 1, jumpToUnread, scrollPos);
        }
